package com.pokemon.pokemonbattle.model;

import com.pokemon.pokemonbattle.utils.Type;
import com.pokemon.pokemonbattle.utils.TypeEffectiveness;
import com.pokemon.pokemonbattle.utils.StatusEffect;
...
public class Skill {
    ...
    double multiplier = com.pokemon.pokemonbattle.utils.TypeEffectiveness.getMultiplier(this.type, target.getType());
