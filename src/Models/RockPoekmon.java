...
public class RockPoekmon extends Pokemon {
    //constructor
    public RockPoekmon(String name, int hp, int attack, int defense, Type type) {
    ...
    public void attack(Pokemon enemy){
        ...
        System.out.println(this.name + " (Rock) menyerang " + enemy.getName());
